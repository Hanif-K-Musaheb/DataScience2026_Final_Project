...
temp_df = masculinity_df[['q0007_0001', 'q0007_0002', 'q0007_0003','q0007_0004',
       'q0007_0005', 'q0007_0006']]

# print(masculinity_df.columns)

# print(demographics_df.head(20))
# print(masculinity_df.head(20))
# print(masculinity_df.columns)

full_dataset =  ['q0001', 'q0002', 'q0004_0001',
